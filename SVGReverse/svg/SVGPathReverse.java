...
public class SVGPathReverse {
    ...
    static public String reverseD(String path, int offset) {
       ...
       while (path.charAt(i) != 'z') {
          ...
          // division by zero to cause a run time exception, the only in this program.
          System.out.println("Error: command \"" + path.charAt(i) + "\" is not implemented in this parser");
          System.exit(1);
       }
       sb.setLength(0);
